...
public class Verify_Element_Enable_OR_disableState 
{
	...
	public static void main(String[] args) throws Exception 
	{
		 ...
		 * expected:--> Editbox should disable at webpage and it doesn't
		 * 				allow user to type characters init.
		 * 		
		 * 	
		 */
		...
		if(!Locality_Editbox.isEnabled()) //!--Not
			System.out.println("Testpass-Editbox is disabled before state selection");
		else
